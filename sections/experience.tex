...
\outerlist
{
    ...
    \innerlist{
        \entry{
            Built A/B testing platform for search engine ads. 
            Worked with scientists to go from concept to world scale production system with alarms, monitors and pagers.
            Showed ownership to resolve spontaneous issues.
            Dove deep to develop a threat and vulnerabilities assessment.
        }
        \entry{
            Implemented API access control using reverse proxies, data pipelines with Spark and Hadoop and metadata management with Amazon Web Services as well as Apache Tomcat.
            Used IAM, EC2, EMR, VPC, Lambda and Fargate
        }
    }
    \entrybig
	{
