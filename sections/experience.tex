...
\outerlist
{
    ...
    \innerlist{
        \entry{
            Secured \textbf{GraphQL} service by requiring all requests to be authenticated and authorised (48 thousand requests/day). Designed and built components to request, issue and verify one-time-access tokens (\href{https://datatracker.ietf.org/doc/html/rfc7519}{RFC 7519}) using JAAS, JPA, MySQL, GraphQL, EJB, Payara, iOS and Android. Used JMeter to load test implementation. Wrote unit and integration tests too.
        }
        \entry{
            Improved user experience by updating the frontend framework for the merchant portal from JSP to JSF and CSS.
        }
        \entry{
            Added a feature to revoke OAuth2 tokens (\href{https://datatracker.ietf.org/doc/html/rfc6749}{RFC 6749}) and found an infinite redirection bug in our implementation of the specification.
        }
    }
